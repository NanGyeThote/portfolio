...
public class view_payment_detail_u extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(pnro == null || pnro.equals("")){
                RequestDispatcher error = request.getRequestDispatcher("view_payment_details_u.jsp");
            	...
            	RequestDispatcher view = request.getRequestDispatcher("view_payment_details_u.jsp");
