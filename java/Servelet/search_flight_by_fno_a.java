...
public class search_flight_by_fno_a extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(flight_no == null || flight_no.equals("")){
                RequestDispatcher error = request.getRequestDispatcher("error_a.jsp");
            	...
            	while (left <= right) {
            	    ...
            	    int compare = midFlightId.compareTo(flight_no);
            	    if (compare == 0) {
            	...
            	RequestDispatcher view = request.getRequestDispatcher("searc_filter_flights_result_a.jsp");
