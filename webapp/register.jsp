...
<body>
	<!-- JDBC Connection -->
	<% 
		String url = "jdbc:mysql:localhost:3306/airreserve";
		String uname = "root";
		String pass = "";
		PreparedStatement st = null;
		String query = "insert into user_details(fullname, username, password, mobileno, email_address, city, state, pincode)";
                            ...
                            <form method="post" action="registration">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <option value="Ayeyarwady(Irrawaddy)">Ayeyarwady(Irrawaddy)</option>
                                        <option value="Bago(Pegu)">Bago(Pegu)</option>
                                        <option value="Chin">Chin </option>
                                        <option value="Kachin">Kachin</option>
                                        <option value="Kayah">Kayah</option>
                                        <option value="Kayin(Karen)">Kayin(Karen)</option>
                                        ...
                                        <option value="Taninthary(Tenasserim)">Taninthary(Tenasserim)</option>
