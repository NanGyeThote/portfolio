                            ...
                            <form method="post" action="add_coupon">
                                <div class="row g-3">
                                    ...
                                    <%  String cname=(String)session.getAttribute("cname");  
                                        out.print(cname); %> , Coupon Failed To Insert In The Data Base, </h4>
                                    <h6 class="text-center">May be Coupon ID/Name Is Not Identical</h6>
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-select" name="cvalue" id="cvalue">
