    ...
    <div class="container-xxl bg-white p-0">
        ...
        %>
                ...
                <tr>
                    ...
                    <td><center>MMK <%=resultSet.getString("first_class_price")%>/-</center></td>
                    <td><center>MMK <%=resultSet.getString("buss_class_price")%>/-</center></td>
                    <td><center>MMK <%=resultSet.getString("eco_class_price")%>/-</center></td>
                </tr>
