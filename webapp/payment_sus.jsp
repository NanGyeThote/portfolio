    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 justify-content-center">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title text-center text-primary text-uppercase">Payment Success</h6>
                                ...
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="view_payment_detail_u">
                                            ...
                                            <h2>Your PNR Number : <% out.print(PNR); %></h2>
                                            <div class="col-md-12">
                                        <div class="position-relative mx-auto" style="max-width: 400px;">
                                            <input type="text" class="form-control w-100 py-3 ps-4 pe-5" id="PNR" name="PNR" placeholder="Please Enter Your PNR HERE">
