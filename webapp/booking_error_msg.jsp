                ...
                <div class="col-lg-9">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <a href="adminlogin.jsp" class="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block">Admin Login<small> 
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">You Need To <span class="text-primary text-uppercase">Register</span> Or <span class="text-primary text-uppercase">Login</span> Before You acn Access <span class="text-primary text-uppercase">Skypalss</span> Booking System</h1>
                </div>
                <div class="row g-4">
