...
<head>
    <meta charset="utf-8">
    <title>SkyPals - Delete Flights Schedule</title>
                            ...
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        ...
                                        <a href="#" class="dropdown-item active"><small>Delete Flight Schedules</small></a>
                                    </div>
                                </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Delete Flight Schedules From DataBase</h6>
                    <h1 class="mb-5">Delete A <span class="text-primary text-uppercase"> Flight Schedule</span></h1>
                </div>
                <div class="row g-5">
