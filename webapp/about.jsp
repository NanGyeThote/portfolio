...
<!DOCTYPE html>
<html lang="en">
<% String pagename="about.jsp"; session.setAttribute("pagename", pagename); %>
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">This is the demo system of Online Flight Booking methodology developed, designed and maintained by SkyPalss.</p>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="rounded shadow overflow-hidden">
                            ...
                            <div class="text-center p-4 mt-3">
                                <h5 class="fw-bold mb-0">Unknown</h5>
