    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/cpnsrch.png);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Search PNR Details</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="admin_login_pass.jsp">Home</a></li>
                            <li class="breadcrumb-item text-white" aria-current="page">Search PNR Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Showing Results <span class="text-primary text-uppercase">For the Payment</span></h1>
            </div>
        </div>
        ...
        <!-- Footer Gapping -->
        <h2 align="center"><font><strong>Showing Payment Details
        ...
        <div class="scroll">
            <table align="center" cellpadding="5" cellspacing="5">
                ...
                <td><b>Address</b></td>
                <td><b>Payment_gateway</b></td>
                <td><b>Payment_id</b></td>
                <td><b>Fair</b></td>
                <td><b>Coupon</b></td>
                <td><b>Discount</b></td>
                <td><b>Actual_fair</b></td>
                </tr>
                <%
                int count = 0;
                //String color = "Blue";
                ...
                <tr>
                    ...
                    <td><center>MMK <%=pList.get(5)%></center></td>
                    <td><center><%=pList.get(6)%> %</center></td>
                    <td><center><%=pList.get(7)%> %</center></td>
                    <td><center>MMK <%=pList.get(8)%></center></td>
                </tr>
                    <%
                            }
                        }
                        if (count == 0) {
                            %>
                        <tr>
                            <td colspan=9 align="center"><b>No Payment Details With This PNR...</b></td>
                        </tr>
            <%            }
            %>
                </table>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="row gy-5 g-4">
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-link" href="contact_c.jsp">Contact Us</a>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="user_login_pass.jsp"> SkyPalss </a>, All Right Reserved. Designed By <a class="border-bottom">SkyPalss</a>
                        </div>
                        <div class="col-md-6 text-center text-md-end">
                            <div class="footer-menu">
                                <a href="user_login_pass.jsp">Home</a>
                                <a href="about_user.jsp">About</a>
