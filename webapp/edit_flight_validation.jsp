...
try
{
         Class.forName("com.mysql.cj.jdbc.Driver");
           ...
           int i=st.executeUpdate("update flight_details set date_of_flight = '"+date_of_flight+"', flight_arrival_time = '"+flight_arrival_time+"', flight_reach_time = '"+flight_reach_time+"', duration = '"+duration+"', first_class_seat = "+first_class_seat+", first_class_seat_booked = "+first_class_seat_booked+", first_class_seat_aval = "+first_class_seat_aval+",buss_class_seat = "+buss_class_seat+", buss_class_seat_booked = "+buss_class_seat_booked+", buss_class_seat_aval = "+buss_class_seat_aval+",eco_class_seat = "+eco_class_seat+", eco_class_seat_booked = "+eco_class_seat_booked+", eco_class_seat_aval = "+eco_class_seat_aval+", first_class_price = "+first_class_price+", buss_class_price ="+buss_class_price+", eco_class_price = "+eco_class_price+" where flight_id = '"+flight_id+"'");
            response.sendRedirect("edit_flight_success.jsp");

        }
        catch(Exception e)
        {
            response.sendRedirect("editflight_failed.jsp");
        }
 %>