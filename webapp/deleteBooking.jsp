        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/addpln.png);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Delete Bookings</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="admin_login_pass.jsp">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Delete Bookings</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <form  method="post" action="deleteBooking">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <button class="btn btn-primary w-100 py-3" type="submit">Delete Booking</button>
                                        </div>
                                    </div>
