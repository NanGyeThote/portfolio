                            ...
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        ...
                                        <a href="deleteflights.jsp" class="dropdown-item active"><small>Delete Flight Schedules</small></a>
                                    </div>
                                </div>
                                <a href="updateflights.jsp" class="nav-item nav-link"><small>Search Flights</small></a>
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/addpln.png);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Deleting Flight Schedules</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="admin_login_pass.jsp">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Deleting Flight Schedules</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h4 class="text-center text-primary text-uppercase">
                                    <%  String flight_id=(String)session.getAttribute("flight_id");  
                                        out.print(flight_id);  
                                    %> , Flight Schedule Failed To Delete/ Invalid Flight Id or Details</h4>
                                    <h3 class="mb-4 text-center">Delete Flight Schedule<span class="text-primary text-uppercase"> <small>By Flight Id</small></span></h3>
                                    <h6 class="text-start text-primary text-center text-uppercase"> <small></small> </h6>
                
                <form method="post" action="dlt_flights">
            <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating">
                                            <select class="form-select" name="flight_name" id="flight_name">
                                                ...
                                                <option value="Air KBZ">Air KBZ</option>
                                           		<option value="Air MAndalay">Air Mandalay</option>
                                            	<option value="Asian Wings Airways">Asian Wings Airways</option>
 												<option value="Air Thanlwin">Air Thanlwin</option>
                                                <option value="Mann Yadanarpon Airlines">Mann Yadanarpon Airlines</option>
                                                <option value="Myanmar Airways International (MAI)">Myanmar Airways International (MAI)</option>
												<option value="Myanmar National Airlines (MNA)">Myanmar National Airlines (MNA)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit">Delete Flight Schedule From The DataBase</button>
                                    </div>
