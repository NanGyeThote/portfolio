...
<head>
    <meta charset="utf-8">
    <title>SkyPalss - Admin Dashboard</title>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h6 class="section-title text-start text-primary text-uppercase">SkyPalss Admin Pannel</h6>
                        <h1 class="mb-4">Admin <span class="text-primary text-uppercase">Dashboard</span></h1>
                        <p class="mb-4">You and go through Admin Dashboard with the Links Below</p>
                        <div class="row g-3 pb-4">
                        <!-- Add Flight -->
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="addflights.jsp">
                                            <h2>Add Flight Schedule</h2>
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">Add Here</button>                                         
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="editflights.jsp">
                                            <h2>Edit Flight Schedule</h2>
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">Edit Here</button>                                         
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="deleteflights.jsp">
                                            ...
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">Delete Here</button>                                         
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="view_result_a.jsp">
                                            <h2>View Bookings</h2>
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">View Here</button>                                         
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="availability_from_admin.jsp">
                                            <h2>Search &nbsp;&nbsp;Flight Schedule</h2>
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">Search Here</button>                                         
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="coupon_add.jsp">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="coupon_delete.jsp">
                                            <h2>Delete Discount Coupon</h2>
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">Delete Here</button>                                         
                                        </form>
                                    </div>
                                </div>
                         ...
                         <!-- Search Coupon -->
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        <form method="post" action="coupon_search.jsp">
                                            <h2>Search Discount Coupon</h2>
                                            <button class="btn btn-primary py-3 px-5 mt-2" type="submit">Search Here</button>                                         
                                        </form>
                                    </div>
                                </div>
