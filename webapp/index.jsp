...
<!DOCTYPE html>
<html lang="en">
<% String pagename="index.jsp"; session.setAttribute("pagename", pagename); %>
<head>
    <meta charset="utf-8">
    ...
    var a = document.getElementById('copy1').value;
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <button id="copy1" onclick="setClipboard('abcdefgh10')" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Copy Code To Clipboard</button>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <button id="copy1" onclick="setClipboard('abcdefgh15')" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Copy Code To Clipboard</button>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                ...
                                <button id="copy1" onclick="setClipboard('abcdefgh25')" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Copy Code To Clipboard</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">SkyPalss</span></h1>
                        <p class="mb-4">This is the demo system of Online Flight Booking methodology developed, designed and maintained by SkyPals.</p>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="view_payment_detail">
                                <div class="row g-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-center text-md-end">
                            <div class="footer-menu">
                                ...
                                <a href="availability.jsp">Check Status</a>
                            </div>
                        </div>
                    </div>
                </div>
