        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5"><span class="text-primary text-uppercase">SkyPalss</span> Provides </h1>
                </div>
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">One-Way Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">Round-trip Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">First Class Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.11s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">Business Class Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.13s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">Coach Ticket</span></h1>
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.14s">
                            <div class="row g-3">
                                <div class="col-6 text-start">
                                    <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="https://blankcanvas-media.s3.eu-west-2.amazonaws.com/wp-content/uploads/2018/10/22215626/shutterstock_382469284.jpg">
                                </div>
                                <div class="col-6 text-start">
                                    <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="https://upload.wikimedia.org/wikipedia/commons/8/8d/Mandalay_Hill_3.jpg">
                                </div>                                
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.17s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">Non-refundable tickets</span></h1>
                        <p class="mb-4">Round-trip tickets are tickets that allow the purchaser to travel to their destination and then back again. This type of ticket is for travelers who have plans to travel on specific dates.</p>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">SkyPalss Provides <span class="text-primary text-uppercase">Refundable ticket</span></h1>
